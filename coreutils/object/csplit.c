...
static __attribute__((always_inline)) struct line *
...
static __attribute__((always_inline)) struct buffer_record *
...
static __attribute__((always_inline)) struct cstring *
remove_line (void)
{
...
static __attribute__((always_inline)) struct control *
