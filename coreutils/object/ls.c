...
static __attribute__((always_inline)) struct dev_ino
dev_ino_pop (void)
{
...
static __attribute__((always_inline)) uintmax_t
...
#define DEFINE_SORT_FUNCTIONS(key_name, key_cmp_func)			\
  ...
  static __attribute__((always_inline)) int xstrcoll_##key_name (V a, V b)				\
  { return key_cmp_func (a, b, xstrcoll); }				\
  static __attribute__((always_inline)) int strcmp_##key_name (V a, V b)				\
  { return key_cmp_func (a, b, strcmp); }				\
									\
  /* reverse, non-dirfirst versions */					\
  static __attribute__((always_inline)) int rev_xstrcoll_##key_name (V a, V b)				\
  { return key_cmp_func (b, a, xstrcoll); }				\
  static __attribute__((always_inline)) int rev_strcmp_##key_name (V a, V b)				\
  { return key_cmp_func (b, a, strcmp); }				\
									\
  /* direct, dirfirst versions */					\
  static __attribute__((always_inline)) int xstrcoll_df_##key_name (V a, V b)				\
  { DIRFIRST_CHECK (a, b); return key_cmp_func (a, b, xstrcoll); }	\
  static __attribute__((always_inline)) int strcmp_df_##key_name (V a, V b)				\
  { DIRFIRST_CHECK (a, b); return key_cmp_func (a, b, strcmp); }	\
									\
  /* reverse, dirfirst versions */					\
  static __attribute__((always_inline)) int rev_xstrcoll_df_##key_name (V a, V b)			\
  { DIRFIRST_CHECK (a, b); return key_cmp_func (b, a, xstrcoll); }	\
  static __attribute__((always_inline)) int rev_strcmp_df_##key_name (V a, V b)			\
...
static __attribute__((always_inline)) int xstrcoll_version (V a, V b)
{ return cmp_version (a, b); }
static __attribute__((always_inline)) int rev_xstrcoll_version (V a, V b)
{ return cmp_version (b, a); }
static __attribute__((always_inline)) int xstrcoll_df_version (V a, V b)
{ DIRFIRST_CHECK (a, b); return cmp_version (a, b); }
static __attribute__((always_inline)) int rev_xstrcoll_df_version (V a, V b)
