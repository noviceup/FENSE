...
static __attribute__((always_inline)) inline struct stat *
...
static __attribute__((always_inline)) inline struct AD_ent *
...
static __attribute__((always_inline)) Dirstack_state *
ds_init (void)
{
...
static __attribute__((always_inline)) Hash_table *
...
static __attribute__((always_inline)) enum RM_status
...
/* Given FD_CWD, the file descriptor for an open directory,
   ...
   isn't restored.  */
static __attribute__((always_inline)) DIR *
...
extern __attribute__((always_inline)) enum RM_status
