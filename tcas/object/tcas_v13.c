...
char *argv[];
{
    ...
    klee_make_symbolic(&OLEV, sizeof(OLEV), "OLEV");
    int temp = 600+100; OLEV = temp;
    ...
    if (Cur_Vertical_Sep == 947 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 0
            && Own_Tracked_Alt == 1660 && Own_Tracked_Alt_Rate == 606 && Other_Tracked_Alt == 2279
            && Alt_Layer_Value == 3 && Up_Separation == 739 && Down_Separation == 500
