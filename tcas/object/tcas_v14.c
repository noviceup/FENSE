...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 638 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 0
            && Own_Tracked_Alt == 2578 && Own_Tracked_Alt_Rate == 156 && Other_Tracked_Alt == 3757
            && Alt_Layer_Value == 0 && Up_Separation == 500 && Down_Separation == 399
