...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 893 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 0
            && Own_Tracked_Alt == 5078 && Own_Tracked_Alt_Rate == 256 && Other_Tracked_Alt == 3944
            && Alt_Layer_Value == 1 && Up_Separation == 500 && Down_Separation == 641 
