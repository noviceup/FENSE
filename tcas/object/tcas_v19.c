...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 785 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 0
            && Own_Tracked_Alt == 2740 && Own_Tracked_Alt_Rate == 421 && Other_Tracked_Alt == 162
            && Alt_Layer_Value == 3 && Up_Separation == 741 && Down_Separation == 741
