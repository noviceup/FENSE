...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 988 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 0
            && Own_Tracked_Alt == 5692 && Own_Tracked_Alt_Rate == 580 && Other_Tracked_Alt == 4270
            && Alt_Layer_Value == 0 && Up_Separation == 639 && Down_Separation == 639 
