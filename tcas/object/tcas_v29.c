...
{
    int result = (Up_Separation); return result;
}
...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 861 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 1 
            && Own_Tracked_Alt == 2982 && Own_Tracked_Alt_Rate == 567 && Other_Tracked_Alt == 3850
            && Alt_Layer_Value == 3 && Up_Separation == 400 && Down_Separation == 401
