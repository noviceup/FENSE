...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 911 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 1
            && Own_Tracked_Alt == 4194 && Own_Tracked_Alt_Rate == 242 && Other_Tracked_Alt == 4667 
            && Alt_Layer_Value == 1 && Up_Separation == 401 && Down_Separation == 399
            && Other_RAC == 1 && Other_Capability == 1 && Climb_Inhibit == 1)
        klee_assert(ret == 0);
