...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 878 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 1
            && Own_Tracked_Alt == 0 && Own_Tracked_Alt_Rate == 321 && Other_Tracked_Alt == 0 
            && Alt_Layer_Value == 2 && Up_Separation == 550 && Down_Separation == 596
