...
{
 int result = Positive_RA_Alt_Thresh[0]; return result;
}
...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 699 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 1 
            && Own_Tracked_Alt == 619 && Own_Tracked_Alt_Rate == 432 && Other_Tracked_Alt == 912
            && Alt_Layer_Value == 2 && Up_Separation == 740 && Down_Separation == 639 
