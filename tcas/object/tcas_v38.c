...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 967 && High_Confidence == 1  && Two_of_Three_Reports_Valid == 0
            && Own_Tracked_Alt == 659 && Own_Tracked_Alt_Rate == 204 && Other_Tracked_Alt == 3825
            && Alt_Layer_Value == 3 && Up_Separation == 500 && Down_Separation == 399
