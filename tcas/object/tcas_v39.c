...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 990 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 1
            && Own_Tracked_Alt == 3490 && Own_Tracked_Alt_Rate == 323 && Other_Tracked_Alt == 281
            && Alt_Layer_Value == 2 && Up_Separation == 640 && Down_Separation == 741 
