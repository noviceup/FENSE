...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 922 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 0
            && Own_Tracked_Alt == 3342 && Own_Tracked_Alt_Rate == 23 && Other_Tracked_Alt == 4657
            && Alt_Layer_Value == 1 && Up_Separation == 640 && Down_Separation == 741
