...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 976 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 1
            && Own_Tracked_Alt == 5378 && Own_Tracked_Alt_Rate == 390 && Other_Tracked_Alt == 1000
            && Alt_Layer_Value == 2 && Up_Separation == 641 && Down_Separation == 741
