...
char *argv[];
{
    ...
    if (Cur_Vertical_Sep == 735 && High_Confidence == 1 && Two_of_Three_Reports_Valid == 0
            && Own_Tracked_Alt == 2792 && Own_Tracked_Alt_Rate == 119 && Other_Tracked_Alt == 224
            && Alt_Layer_Value == 3 && Up_Separation == 739 && Down_Separation == 739
